...
def get_system_prompt(prompt_name: str) -> str:
    ...
    return template["content"]  # type: ignore[no-any-return]
...
class PromptLibrary:
    ...
    _instance: ClassVar["PromptLibrary | None"] = None
    _prompts: ClassVar[dict[str, dict[str, Any]]] = {}
    ...
    def get_system_prompt(self, name: str) -> str:
        """获取系统提示词"""
        return self.get(name)["content"]  # type: ignore[no-any-return]

    def get_metadata(self, name: str) -> dict[str, Any]:
        """获取元数据"""
        return self.get(name)["metadata"]  # type: ignore[no-any-return]
